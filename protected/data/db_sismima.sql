...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2015 a las 12:18:05
...
(1, 'Leche Gloria', 'Lata', 9, '0', 135, 1, 4, '2015-05-07 11:34:02', '1', '2.00'),
...
(15, 'Inca Kola 1Litro', 'Botella', 1, '0', 53, 9, 5, '2015-05-17 09:49:12', '1', '3.00'),
...
(24, 'oreo', 'bolsa', 1, '1', 30, 3, 2, '2015-05-17 09:49:12', '1', '5.00'),
...
(38, 'Salsa roja', 'bolsa', 1, '1', 100, 10, 9, '2015-05-25 11:44:00', '1', '2.10'),
...
--
ALTER TABLE `admopcion`
MODIFY `ide_opcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `admrolopcion`
MODIFY `ide_rolopcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `inventario`
MODIFY `idMovimiento` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113;
--
