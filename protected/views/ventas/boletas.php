...
<!-- Main content -->
        ...
        <div class="modal fade" id="myModalNuevoBoleta" tabindex="-1" role="dialog" aria-labelledby="myModalNuevoBoletaLabel" aria-hidden="true">
          <div class="modal-dialog  modal-lg">
            <div class="modal-content">
              <!-- Cabecera -->
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="$('#myModalNuevoBoleta').modal('hide');" ><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" id="myModalNuevoBoletaLabel">Boleta <b>Nro.</b>  <span id="nroSerie" data-param="" ></span>-<span id="nroBoleta" data-nro=""></span><img class="loading-small-precarga" style="display: none;" src="<?php echo Yii::app()->theme->baseUrl;?>/dist/img/loading.gif" /></h4>
              </div>
...
<form class="form-inline col-xs-12">
  <div class="form-group">
          ...
          <table  class="table table-striped table-bordered" cellspacing="0" width="100%" id="DetalleFactura" data-Documento="boleta" style="">
            <thead>
              <tr>
                <!--th style="vertical-align: middle;">#</th-->
                <th style="vertical-align: middle;" >Codigo</th>
     ...
     <div class="form-inline col-xs-9">
      ...
      <label for="" style="color:transparent;">registrar</label> <br>       
          <button id="add_Boleta" class="btn btn-primary "><i class="fa fa-floppy-o"></i> Registrar Boleta</button> 
      </div>
